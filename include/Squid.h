...
namespace insur {
    ...
    public:
		...
		bool irradiateTracker(std::string irradiationfile);
        ...
        bool buildFullSystem(std::string geomfile, std::string settingsfile, std::string matfile, std::string irradiationfile, bool usher_verbose = false, bool mat_verbose = false);
        bool buildFullSystem(std::string geomfile, std::string settingsfile, std::string matfile, std::string& pixmatfile, std::string irradiationfile, bool usher_verbose = false, bool mat_verbose = false);
