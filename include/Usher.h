...
namespace insur {
  ...
  class Usher {
  public:
    struct LayerServiceCoordinates{
      std::vector<double> zPlusValues;
      std::vector<double> zMinusValues;
      double radius;
    };
    Usher() {}
    virtual ~Usher() {}
  ...
  protected:
    ...
    public:
      ...
      double maxZBarrel(int barrelindex);
    ...
    protected:
      ...
      /**
       * contains points for building the services of the layers
       * external vector is for the layers, internal for the modules of each layer, the pair represent a coordinate in Z,rho
       */
      std::vector<LayerServiceCoordinates> layersServiceCoordinates;
    private:
      bool post_analysis;
      ...
      std::vector<LayerServiceCoordinates> analyzeLayers(Tracker& tracker);
    ...
    virtual InactiveSurfaces& servicesModules(TrackerIntRep& tracker, InactiveSurfaces& is);
  private:
    ...
    InactiveSurfaces& addModuleServiceTube(InactiveSurfaces& is, double length, double offset, double radius, double width, bool final);
